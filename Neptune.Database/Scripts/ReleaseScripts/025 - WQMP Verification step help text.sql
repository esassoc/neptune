...
BEGIN
    ...
    VALUES
        (92, '<p>Walk through each step to record this O&amp;M Verification visit. The BMP-related steps (Structural, Simplified, Source Control) are <strong>all optional</strong> &mdash; record only the BMPs you inspected. You can save and continue at any time, or come back later to finish a draft.</p>'),
