...
export class WqmpsLayerComponent {
    readonly WFS_FEATURE_TYPE = "OCStormwater:WaterQualityManagementPlans";
    readonly WMS_LAYER_NAME = "OCStormwater:WaterQualityManagementPlans";
    readonly IDENTIFIER_PROPERTY = "WaterQualityManagementPlanID";
