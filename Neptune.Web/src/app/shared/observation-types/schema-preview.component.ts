    ...
    template: `
        @if (collectionMethod === "PassFail" && passFailSchema) {
            <dl class="grid-12">
                ...
                <dt class="g-col-4">Assessment Instruction</dt><dd class="g-col-8">{{ passFailSchema.AssessmentDescription }}</dd>
        ...
        @if (collectionMethod === "DiscreteValue" && discreteSchema) {
            <dl class="grid-12">
                ...
                <dt class="g-col-4">Benchmark Instruction</dt><dd class="g-col-8">{{ discreteSchema.BenchmarkDescription }}</dd>
                <dt class="g-col-4">Threshold Instruction</dt><dd class="g-col-8">{{ discreteSchema.ThresholdDescription }}</dd>
                <dt class="g-col-4">Assessment Instruction</dt><dd class="g-col-8">{{ discreteSchema.AssessmentDescription }}</dd>
        ...
        @if (collectionMethod === "Percentage" && percentageSchema) {
            <dl class="grid-12">
                ...
                <dt class="g-col-4">Benchmark Instruction</dt><dd class="g-col-8">{{ percentageSchema.BenchmarkDescription }}</dd>
                <dt class="g-col-4">Threshold Instruction</dt><dd class="g-col-8">{{ percentageSchema.ThresholdDescription }}</dd>
                <dt class="g-col-4">Assessment Instruction</dt><dd class="g-col-8">{{ percentageSchema.AssessmentDescription }}</dd>
