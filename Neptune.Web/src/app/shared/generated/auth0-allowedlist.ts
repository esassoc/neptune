...
const SECURED_REGEX: RegexMap = {
  ...
  'POST': [
    ...
    new RegExp("^/water-quality-management-plans/[^/]+/extraction-result/apply-field$"),
    new RegExp("^/water-quality-management-plans/[^/]+/extraction-result/apply-parcel$"),
    new RegExp("^/water-quality-management-plans/[^/]+/extraction-result/apply-quick-bmp$"),
