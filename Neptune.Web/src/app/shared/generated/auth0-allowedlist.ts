...
const SECURED_EXACT: ExactMap = {
  'DELETE': ["/delineations/gdb/staging","/land-use-blocks/staging","/onland-visual-trash-assessment-areas/gdb-staging"],
  'GET': ["/data-hub/last-updated","/data-hub/upload-templates/trash-screen","/delineations","/delineations/gdb/staging-report","/delineations/reconciliation-report/context","/delineations/reconciliation-report/discrepancies","/delineations/reconciliation-report/overlaps","/field-visits","/funding-sources","/hru-characteristics","/jurisdictions","/land-use-blocks/staging-report","/load-generating-units","/maintenance-records","/manager-dashboard/bmps/provisional","/manager-dashboard/delineations/provisional","/manager-dashboard/field-visits/provisional","/nearby-assets","/nereid/config","/nereid/delta-solve","/nereid/delta-solve-test","/nereid/health","/nereid/land-surface-loading","/nereid/land-surface-loading-baseline","/nereid/land-surface-table","/nereid/no-treatment-facility-validate","/nereid/solution-sequence","/nereid/solution-test-case","/nereid/subgraph","/nereid/total-network-graph","/nereid/treatment-facilities","/nereid/treatment-facility-validate","/nereid/treatment-sites","/nereid/validate","/onland-visual-trash-assessment-areas","/onland-visual-trash-assessment-areas/gdb-staging-report","/onland-visual-trash-assessments","/organization-types","/organizations","/parcels","/parcels/search","/projects","/projects/OCTAM2Tier2GrantProgram","/projects/OCTAM2Tier2GrantProgram/download","/projects/OCTAM2Tier2GrantProgram/treatmentBMPs/download","/projects/delineations","/projects/download","/projects/treatmentBMPs/download","/regional-subbasin-revision-requests","/regional-subbasins","/trash-generating-units","/treatment-bmp-assessments","/treatment-bmp-assessments/latest-by-bmp","/treatment-bmp-types/grid","/treatment-bmps/download-gdb","/treatment-bmps/for-delineation-map","/treatment-bmps/modeling-attributes","/treatment-bmps/octa-m2-tier2-grant-program","/treatment-bmps/picker","/treatment-bmps/planned-projects","/users","/water-quality-management-plan-documents","/water-quality-management-plan-verifies","/water-quality-management-plans","/water-quality-management-plans/annual-report/approval-summary","/water-quality-management-plans/annual-report/options","/water-quality-management-plans/annual-report/post-construction-verifications","/water-quality-management-plans/display-dtos","/water-quality-management-plans/hydrologic-subareas","/water-quality-management-plans/lgu-audit-grid","/water-quality-management-plans/picker","/water-quality-management-plans/source-control-bmp-attributes","/water-quality-management-plans/with-final-document"],
  'POST': ["/custom-attribute-types","/delineations/gdb/approve","/delineations/gdb/download","/delineations/gdb/upload","/delineations/reconciliation-report/enqueue-check","/field-visits/bulk-upload-trash-screen","/funding-sources","/graph-trace-as-feature-collection-from-point","/hru-characteristics/enqueue-refresh","/impersonation/stop","/land-use-blocks/download-gdb","/land-use-blocks/staging/approve","/land-use-blocks/upload-gdb","/manager-dashboard/bmps/bulk-verify","/manager-dashboard/delineations/bulk-verify","/manager-dashboard/field-visits/bulk-verify","/model-basins/enqueue-refresh","/observation-types","/octa-prioritizations/enqueue-refresh","/onland-visual-trash-assessment-areas/download-gdb","/onland-visual-trash-assessment-areas/gdb-approve","/onland-visual-trash-assessment-areas/gdb-upload","/onland-visual-trash-assessments","/onland-visual-trash-assessments/bulk-upload","/organizations","/parcels/enqueue-refresh","/parcels/lookup-by-numbers","/precipitation-zones/enqueue-refresh","/projects","/regional-subbasins/enqueue-refresh","/treatment-bmp-types","/treatment-bmps","/treatment-bmps/bulk-upload","/user-claims","/users","/water-quality-management-plan-documents","/water-quality-management-plans","/water-quality-management-plans/bulk-upload-xlsx","/water-quality-management-plans/download-gdb","/water-quality-management-plans/upload","/water-quality-management-plans/upload-boundary-from-apns","/water-quality-management-plans/upload-simplified-bmps"],
  'PUT': ["/land-use-blocks"],
};
...
const ANON_REGEX: RegexMap = {
  ...
  'GET': [
    ...
    new RegExp("^/treatment-bmps/[^/]+/benchmarks-and-thresholds/[^/]+$"),
    new RegExp("^/treatment-bmps/[^/]+/benchmarks-and-thresholds/with-observation-types$"),
    ...
    new RegExp("^/treatment-bmps/[^/]+/funding-events/[^/]+$"),
    new RegExp("^/treatment-bmps/[^/]+/load-reducing-result$"),
...
const SECURED_REGEX: RegexMap = {
  ...
  'GET': [
    ...
    new RegExp("^/funding-sources/[^/]+$"),
    new RegExp("^/funding-sources/[^/]+/treatment-bmps$"),
    ...
    new RegExp("^/organizations/[^/]+$"),
    new RegExp("^/organizations/[^/]+/funding-sources$"),
    new RegExp("^/organizations/[^/]+/users$"),
    new RegExp("^/project-documents/[^/]+$"),
    new RegExp("^/projects/[^/]+$"),
  ...
  'POST': [
    ...
    new RegExp("^/treatment-bmps/[^/]+/field-visits$"),
    new RegExp("^/treatment-bmps/[^/]+/funding-events$"),
    new RegExp("^/treatment-bmps/[^/]+/mark-provisional$"),
    new RegExp("^/treatment-bmps/[^/]+/treatment-bmp-documents$"),
    new RegExp("^/treatment-bmps/[^/]+/treatment-bmp-images$"),
    new RegExp("^/treatment-bmps/[^/]+/verify-inventory$"),
