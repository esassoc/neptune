...
export class LandUseBlockGdbDownloadRequestDto { 
...
export interface LandUseBlockGdbDownloadRequestDtoForm { 
    StormwaterJurisdictionID?: FormControl<number>;
}

export class LandUseBlockGdbDownloadRequestDtoFormControls { 
