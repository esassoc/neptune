...
export class SupportRequestSubmissionDto { 
    Name?: string | null;
    Email?: string | null;
...
export interface SupportRequestSubmissionDtoForm { 
...
export class SupportRequestSubmissionDtoFormControls { 
    ...
    public static Organization = (value: FormControlState<string> | string = undefined, formControlOptions?: FormControlOptions | null) => new FormControl<string>(
        value,
        formControlOptions ?? 
        {
            nonNullable: false,
