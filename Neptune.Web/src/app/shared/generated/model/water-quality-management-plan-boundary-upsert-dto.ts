...
export class WaterQualityManagementPlanBoundaryUpsertDto { 
...
export interface WaterQualityManagementPlanBoundaryUpsertDtoForm { 
    GeometryAsGeoJson?: FormControl<string>;
}

export class WaterQualityManagementPlanBoundaryUpsertDtoFormControls { 
