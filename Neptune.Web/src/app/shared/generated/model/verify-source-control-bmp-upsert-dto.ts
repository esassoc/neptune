...
export class VerifySourceControlBMPUpsertDto { 
...
export interface VerifySourceControlBMPUpsertDtoForm { 
    SourceControlBMPID?: FormControl<number>;
    WaterQualityManagementPlanSourceControlCondition?: FormControl<string>;
}

export class VerifySourceControlBMPUpsertDtoFormControls { 
