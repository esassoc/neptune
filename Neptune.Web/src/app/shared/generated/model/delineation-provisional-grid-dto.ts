...
export class DelineationProvisionalGridDto { 
...
export interface DelineationProvisionalGridDtoForm { 
...
export class DelineationProvisionalGridDtoFormControls { 
    ...
    public static DelineationAreaInAcres = (value: FormControlState<number> | number = undefined, formControlOptions?: FormControlOptions | null) => new FormControl<number>(
        value,
        formControlOptions ?? 
        {
            nonNullable: false,
